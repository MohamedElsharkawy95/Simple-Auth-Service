...
{
    /// <inheritdoc />
    public partial class addClassesActivitiesHomeworkFilesTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentClasses_AspNetUsers_UserId1",
                        column: x => x.UserId1,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Activities_StudentClasses_StudentClassId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeworkFiles_Activities_ActivityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_StudentClassId",
                table: "Activities",
                column: "StudentClassId");

            migrationBuilder.CreateIndex(
                name: "IX_HomeworkFiles_ActivityId",
                table: "HomeworkFiles",
                column: "ActivityId");
